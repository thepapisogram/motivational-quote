        ...
        <div className={clsx("my-auto mx-auto p-10 rounded-2xl drop-shadow-lg bg-white dark:bg-zinc-950 backdrop-blur-md w-11/12 md:w-6/12 lg:w-4/12 xl:w-5/12 duration-500 transition-all",
          ...
          {!loading && (
            <section className="my-5">
              ...
              <p className="mt-3 text-lg text-right font-bold text-black">{`- ${quote.author}`}</p>
            </section>
          )}
          {loading && (
          ...
          <div className="grid">
            ...
            <div className="flex justify-center gap-5">
              <Link href="/" className="bg-green-800 hover:bg-green-950 duration-400 text-white p-2 px-10 rounded-full transition-all">Change Quotes</Link>
              <button onClick={fetchQuote} className="bg-green-800 hover:bg-green-950 duration-400 text-white p-2 px-10 rounded-full transition-all">Next Quote</button>
            </div>
            <p className="mt-4 text-center opacity-50 dark:opacity-20 tracking-widest font-bold text-black dark:text-white">Developed by Group 5</p>
          </div>
        </div>
      </main>
    </>
